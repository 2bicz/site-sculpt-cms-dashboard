...
export const Posts = () => {
    ...
    const prepareTableRow = ({ title, createdAt, createdBy, status, categories }) => {
        return {
          ...
          "created at": (<SoftTypography variant="caption" color="secondary" fontWeight="medium">{ createdAt }</SoftTypography>),
          "created by": (<SoftTypography variant="caption" color="secondary" fontWeight="medium">{ createdBy }</SoftTypography>),
          "status": (<SoftTypography variant="caption" color="secondary" fontWeight="medium">{ status }</SoftTypography>),
          "categories": (<SoftTypography variant="caption" color="secondary" fontWeight="medium">{ categories }</SoftTypography>),
          "edit post": (
              <SoftButton 
                onClick={() => {
    ...
    useEffect(() => {
        if (websiteId) {
            api.get(`/post/get-all-by-website${websiteId}`)
            .then((response) => {
